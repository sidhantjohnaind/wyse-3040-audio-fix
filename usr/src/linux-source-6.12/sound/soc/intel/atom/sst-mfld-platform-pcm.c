...
#define SST_RATES (SNDRV_PCM_RATE_44100 | SNDRV_PCM_RATE_48000 | \
		   SNDRV_PCM_RATE_88200 | SNDRV_PCM_RATE_96000 | \
		   SNDRV_PCM_RATE_176400 | SNDRV_PCM_RATE_192000)
#define SST_FORMATS (SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S24_LE)
		...
		struct snd_soc_dai *dai)
{
	 ...
	 */
	/* Allow flexible period and buffer sizes for rates other than 48kHz */
				...
				struct snd_soc_dai *dai)
{
	...
	if (params_rate(params) == 44100)
		ctx->ssp_cmd.frame_sync_frequency = SSP_FS_44_1_KHZ;
	else if (params_rate(params) == 48000)
		ctx->ssp_cmd.frame_sync_frequency = SSP_FS_48_KHZ;
